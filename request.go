...
type RequestOptions struct {
	// Params is a map of key-value pairs that will e added to the Request.
...
// RawRequest accepts a verb, URL, and RequestOptions struct and returns
// the constructed http.Request and any errors that occurred
func (c *Client) RawRequest(verb, p string, ro *RequestOptions) (*http.Request, error) {
	// Ensure we have a request options.
	if ro == nil {
